                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 opacity-90">Perbarui artikel "<?= character_limiter(esc($article['title']), 50) ?>"</p>
                        </div>
                        <div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="form-card">
                            ...
                            <div class="card-body">
                                <?= form_open('/admin/article/update/' . $article['id'], ['class' => 'needs-validation', 'novalidate' => true]) ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control <?= (session('validation') && isset(session('validation')['content'])) ? 'is-invalid' : '' ?>" 
                                                  ...
                                                  required
                                                  oninput="updateCharacterCount(this)"><?= old('content', $article['content']) ?></textarea>
